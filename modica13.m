...
% TriggerStep: XMI#_GJIr0M4jEeiWJNS4aJg8DA

% Current Change (Action -> Action) {Project}

Charge_Current = [0 2.5];
% Action {Project}

% NamingFragmentStep: Charging: 0 Speed: 0 PBrake: 0 SoC: 0 BTemp: 0 BWarn: 0 ChgPlug: 0 ChgRecog: 0 ChgCurr: 2.5 CIntrpt: 0  IgnSt: 0 | 
