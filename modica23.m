...
% TriggerStep: XMI#_Ty7iUM4jEeiWJNS4aJg8DA

% Charge Interruptions Count (Action -> Action) {Project}

Charge_Interruptions_Count = [0 12];
% Action {Project}

% NamingFragmentStep: Charging: 0 Speed: 0 PBrake: 0 SoC: 0 BTemp: 0 BWarn: 0 ChgPlug: 0 ChgRecog: 0 ChgCurr: 0 CIntrpt: 12  IgnSt: 0 | 
