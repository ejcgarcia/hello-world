...
% TriggerStep: XMI#_heyp0M4tEeiWJNS4aJg8DA

% Battery Warnings Change (Action -> Action) {Project}

Battery_Warnings = [0 1];
% Action {Project}

% NamingFragmentStep: Charging: 1 Speed: 0 PBrake: 1 SoC: 0 BTemp: 0 BWarn: 1 ChgPlug: 1 ChgRecog: 1 ChgCurr: 0 CIntrpt: 0  IgnSt: 15 | 
