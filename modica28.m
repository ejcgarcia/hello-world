...
% TriggerStep: XMI#_w3UsUM4oEeiWJNS4aJg8DA

% Speed Change (Action -> Action) {Project}

Vehicle_Speed = [0 -10];
% Action {Project}

% NamingFragmentStep: Charging: 0 Speed: -10 PBrake: 1 SoC: 0 BTemp: 0 BWarn: 0 ChgPlug: 1 ChgRecog: 0 ChgCurr: 0 CIntrpt: 0  IgnSt: 0 | 
